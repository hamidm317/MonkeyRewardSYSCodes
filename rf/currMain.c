...
/*	if( SDL_Init( SDL_INIT_VIDEO ) < 0 ){
	...
	//SDL_Surface* screenSurface = NULL;
		...
		*/
		...
		window = SDL_CreateWindow( "RF Task",bound1.x, bound1.y, bound1.w, bound1.h, SDL_WINDOW_BORDERLESS | SDL_WINDOW_ALWAYS_ON_TOP);
		...
		window2 = SDL_CreateWindow( "RF Task",bound2.x, bound2.y, bound2.w, bound2.h, SDL_WINDOW_SHOWN | SDL_WINDOW_RESIZABLE);
			...
			randGen(256, randomSequenseNumbers,1);
			//for (int i=0; i<64; i++)
...
writeConfigToEyelink(){
                ...
                eyemsg_printf(" -erramp = %f", errorVolume);
                eyemsg_printf(" -sucamp = %f", successVolume);
}
