...
#define PSEUDORAND_QUEUE_LEN_1 24
#define PSEUDORAND_QUEUE_LEN_2 6
#define PSEUDORAND_QUEUE_BATCH_1 4
#define PSEUDORAND_NUMBER_OF_FRACTS 8
...
extern int currentSequenceNumberFV;
...
extern int frequencyOfFV;
extern int flipThreshold;
...
typedef enum {Experiment_Type_Force, Experiment_Type_Choice, Experiment_Type_Free} experimentTypeEnum;
...
void FVPerm(int len, int *fractalIdxs, int *regionType);
